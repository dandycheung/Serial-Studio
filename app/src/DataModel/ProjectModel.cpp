...
/**
 * @brief Snapshots the current driver settings for source into Source::connectionSettings.
 */
...
/**
 * @brief Prompts for a register name and appends a register with zero default.
 */
...
/**
 * @brief Materialises synthetic workspaces and flips into customize mode.
 */
...
/**
 * @brief Shifts user-customised widget refs after a dataset deletion.
 */
...
/**
 * @brief Clears workspaces and widget settings for sessions with no project file.
 */
